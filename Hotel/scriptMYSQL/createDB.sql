...
insert into reserva (hosp_id, quarto_id, data_inicio, data_fim, check_in) values (1,1,"2013-04-03", "2013-04-07", false);
insert into reserva (hosp_id, quarto_id, data_inicio, data_fim, check_in) values (2,4,"2013-04-09", "2013-04-14", false);
insert into reserva (hosp_id, quarto_id, data_inicio, data_fim, check_in) values (3,6,"2013-04-21", "2013-04-25", false);
insert into reserva (hosp_id, quarto_id, data_inicio, data_fim, check_in) values (4,5,"2013-04-30", "2013-05-05", false);
insert into reserva (hosp_id, quarto_id, data_inicio, data_fim, check_in) values (1,12,"2013-04-30", "2013-05-05", false);
insert into reserva (hosp_id, quarto_id, data_inicio, data_fim, check_in) values (10,6,"2013-05-03", "2013-05-07", false);
insert into reserva (hosp_id, quarto_id, data_inicio, data_fim, check_in) values (11,10,"2013-05-11", "2013-05-15", false);
insert into reserva (hosp_id, quarto_id, data_inicio, data_fim, check_in) values (5,2,"2013-05-14", "2013-05-20", false);
insert into reserva (hosp_id, quarto_id, data_inicio, data_fim, check_in) values (1,1,"2013-05-27", "2013-06-02", false);
insert into reserva (hosp_id, quarto_id, data_inicio, data_fim, check_in) values (6,8,"2013-06-23", "2013-06-30", true);
insert into reserva (hosp_id, quarto_id, data_inicio, data_fim, check_in) values (7,2,"2013-06-25", "2013-06-30", true);
insert into reserva (hosp_id, quarto_id, data_inicio, data_fim, check_in) values (8,10,"2013-06-29", "2013-06-30", true);
